...
import {
  ...
  useGetReleasesQuery
} from "./chunk-ARO4JLBZ.js";
import {
  buildValidParams as buildValidParams2,
  getStageColorByHex
} from "./chunk-TYSNT5KH.js";
import {
...
} from "./chunk-SPM6LGAO.js";
import {
  useTypedSelector
} from "./chunk-547YWF62.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-PDLGSQVM.js";
import {
  useConfig
} from "./chunk-OWDENHKG.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-QTLYQEG4.js";
import {
  pluginId
} from "./chunk-SQLDXQZE.js";
import {
  useDocumentActions
} from "./chunk-5BWIPUCP.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
...
import {
  ...
  Formik,
  useFormik
} from "./chunk-V45UDSP6.js";
import {
  useTracking
} from "./chunk-FD2H3MIB.js";
import {
  useLicenseLimits
} from "./chunk-M4WEITZ7.js";
import {
  Table,
  useTable
} from "./chunk-UTA4CBMC.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3
...
import {
  useRBAC
} from "./chunk-KYADUQO6.js";
import {
  useAdminUsers
} from "./chunk-FANXGEP7.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-HHVS26SF.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-VS36BHZL.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-ORY47LVC.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-DH3OAEDB.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-W74UFIYQ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-3FHVSOTU.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-IRNHHRTU.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-4X7Z3MXF.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-SJFRUTVH.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-AYION3VE.js");
          return {
...
//# sourceMappingURL=chunk-66LHFJC7.js.map
