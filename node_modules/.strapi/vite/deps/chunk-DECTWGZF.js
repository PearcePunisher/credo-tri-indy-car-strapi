...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-OUZTJLSQ.js");
    ...
    case "./translations/fr.json":
      return import("./fr.json-6F6MC3Z6.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-TKSLO3BZ.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-32BHGULB.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-32BHGULB.js");
...
//# sourceMappingURL=chunk-DECTWGZF.js.map
