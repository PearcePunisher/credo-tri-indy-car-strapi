...
} from "./chunk-HAS43OIP.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-3CKYJR7Z.js";
import {
...
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-GTEQNAPC.js";
import {
  require_pick
} from "./chunk-BLPDUKN6.js";
import {
  useEnterprise
} from "./chunk-LC2GP6XA.js";
import {
  Login
} from "./chunk-S3LAFUUE.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-K4EBNYXT.js";
import {
  ConfigurationProvider
} from "./chunk-FL3QPKVK.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-7X4C5GRW.js";
import {
  require_baseRest
} from "./chunk-R2CG675D.js";
import {
  HistoryProvider
} from "./chunk-CUPMVYFR.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-DBPFTB27.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-X67JJ344.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-VKXGQLZG.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-6HKQE6YV.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-2DUIBYNG.js";
import {
  MemoizedInputRenderer
} from "./chunk-ZSLDPRJP.js";
import {
  Form
} from "./chunk-VIZY6SMM.js";
import {
  Layouts
} from "./chunk-2HRSNWYO.js";
import {
  getByteSize
...
} from "./chunk-Z3KLVZ6G.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-F4HYMDIY.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
...
import {
  ...
  useNotification
} from "./chunk-GXSTFGNO.js";
import {
  provider_default,
  useIntl
} from "./chunk-AUMNHLFQ.js";
import {
  require_client
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-RU767SX6.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-QRR37CUY.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-DWOWYL7H.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-5NHS7FMX.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-Z7HBQAUN.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-7UW5CZV7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-6TP6AJIB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CJMKGMXK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-QX2K2QPE.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-3GOH63LP.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-ALS77KDS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-5EWQRXHY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-2GWPJD7D.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-ZEIXQQI5.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-RUUUN7QT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-Y5FOP5TZ.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-6OTEWZCO.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-IMRE3I7Q.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-RNMT24PZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-6R4SSBLS.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-3EOMMIKF.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-YX23N7PE.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-6KZE4VNS.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-WK5CZNFP.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-KHB6KYUK.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-PQUG2YDF.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-KAJHNBPF.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-7BL3AUU3.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-MENHE7PI.js");
              return {
...
//# sourceMappingURL=chunk-ZIKDJNGU.js.map
