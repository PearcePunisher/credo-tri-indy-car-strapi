...
import {
  LimitsModal
} from "./chunk-M6TRRNZF.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-E32TQEMT.js";
import {
  getStageColorByHex
} from "./chunk-WUSH5OFA.js";
import {
...
} from "./chunk-K5W2PLVT.js";
import {
  useTypedSelector
} from "./chunk-I7U4PH7K.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-UTZXX4XN.js";
import {
  useConfig
} from "./chunk-4Z5JLA4N.js";
import {
  AssetSource,
  AssetType,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-DEGONKGV.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-FXOD4S5U.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-CDXFAGW3.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-TIEYMAR2.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-6FUPC3RN.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-CDIAKPBA.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-B446MVRN.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-DYXWONMK.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-LLGPCOCU.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-DUI6B3HO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-4H65A5HC.js");
          return {
...
//# sourceMappingURL=chunk-QOJUNNFM.js.map
