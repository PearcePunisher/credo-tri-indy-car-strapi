...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-NPQSTGEM.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-TIJNTKRP.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-FLXTWA2J.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-FLXTWA2J.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-FLXTWA2J.js");
...
//# sourceMappingURL=chunk-GYW5OQ75.js.map
