...
} from "./chunk-7C7SN2C2.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-GIVYC7EJ.js";
import {
...
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-I7NBSXO7.js";
import {
  require_pick
} from "./chunk-Z5K3EEXO.js";
import {
  useEnterprise
} from "./chunk-HESTQQUH.js";
import {
  Login
} from "./chunk-27FTEA6J.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-ECRCO47I.js";
import {
  ConfigurationProvider
} from "./chunk-G2SYI2BQ.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-HRRHIPCT.js";
import {
  require_baseRest
} from "./chunk-WVYSQCVC.js";
import {
  HistoryProvider
} from "./chunk-VTAUGDSE.js";
import {
  errorsTrads
...
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-ESNXZ5TC.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-KYGPBKH3.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-3POBGR7P.js";
import {
  MemoizedInputRenderer
} from "./chunk-3AGM522T.js";
import {
  Form
} from "./chunk-KMCEBOP3.js";
import {
  Layouts
} from "./chunk-NZWKA5LG.js";
import {
  getByteSize
...
} from "./chunk-MK42OM5W.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-DRNZY5EA.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-BHVOVRA5.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-74ZV62XD.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-EOEEL7NK.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-6RVMJ5QA.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BXW6OP7G.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-DVXTXJP3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-FXB4VP6V.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LVFV4KJW.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-GV7NQHKM.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-LUIN4G4H.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-ZYZ2OFX7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-A2YMED6Q.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-4F6WZZSY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-XRFGXQCA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-IHRABZMQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-O7OMYM53.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-KHTDHAYI.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-537E5O5U.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-EDIPKHXQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-JKNVK6ML.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-MEW5YZMT.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-WP5BAWEP.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-WFZSV2NE.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-DA77BNOJ.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-MBQJGXHX.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-DLJ7XGFX.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-DNGRFFCG.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-CW3PTAAK.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-N43EI3NC.js");
              return {
...
//# sourceMappingURL=chunk-WBF3ZPZ2.js.map
