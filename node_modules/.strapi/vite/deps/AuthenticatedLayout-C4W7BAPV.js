...
import {
  PrivateRoute
} from "./chunk-IUUCYRVW.js";
import {
  LAYOUT_DATA,
  Number,
  STATES,
  VerticalDivider
} from "./chunk-NNPFQB2L.js";
import {
  useGuidedTour
} from "./chunk-5W5L5433.js";
import {
  tours,
  useScopedPersistentState
} from "./chunk-NPRFDRIJ.js";
import {
  useLicenseLimits
} from "./chunk-5EK6LYOM.js";
import "./chunk-SHODGURD.js";
import {
  getDisplayName,
  getInitials,
  hashAdminUserEmail
...
import {
  useConfiguration
} from "./chunk-G7JB4CLV.js";
import "./chunk-BMDSOOOE.js";
import {
  AppInfoProvider,
  useTracking
...
`;
var LinkImpl = ({ children, ...props }) => (0, import_jsx_runtime4.jsx)(MainNavLinkWrapper, {
  ...props,
  children
});
...
var GuidedTourTooltip = ({ to, children }) => {
  ...
  switch (normalizedTo) {
    case "content-manager":
      return (0, import_jsx_runtime7.jsx)(tours.contentTypeBuilder.Finish, {
        children
      });
    case "":
      return (0, import_jsx_runtime7.jsx)(tours.apiTokens.Finish, {
        children
      });
    case "settings":
      return (0, import_jsx_runtime7.jsx)(tours.contentManager.Finish, {
        children
      });
    default:
      return children;
      ...
      (0, import_jsx_runtime7.jsx)(NavListWrapper, {
        ...
        children: listLinks.length > 0 ? listLinks.map((link) => {
          ...
          return (0, import_jsx_runtime7.jsx)(Flex, {
            tag: "li",
            children: (0, import_jsx_runtime7.jsx)(GuidedTourTooltip, {
              to: link.to,
...
//# sourceMappingURL=AuthenticatedLayout-C4W7BAPV.js.map
