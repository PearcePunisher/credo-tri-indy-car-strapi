...
} from "./chunk-WCFZ3FIA.js";
import {
  useTypedSelector
} from "./chunk-MQGO4TPR.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-2M4UGTJ2.js";
import {
  useConfig
} from "./chunk-2HMGHIO6.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-BSN265CX.js";
import {
  useDocumentActions
} from "./chunk-T763BPL2.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-XUOQKXN6.js";
import {
  pluginId
} from "./chunk-SQLDXQZE.js";
import {
  renderAdmin
} from "./chunk-M5TYDQAN.js";
import {
  useLicenseLimits
} from "./chunk-RKGCI4XL.js";
import {
  Table,
  useTable
} from "./chunk-PQ2DZWRB.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-5HBPBO27.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-ALNIGVBT.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-4QYDDEB3.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-ZASTMTIX.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-YE3PBF3A.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-EEL7ULZJ.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-TGHYFKKV.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-VEI2UD2J.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-3DUH6FI7.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-AROW6ONL.js");
          return {
...
//# sourceMappingURL=chunk-2GPX6K54.js.map
