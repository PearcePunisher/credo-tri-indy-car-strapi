...
} from "./chunk-NYRNWQF3.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-ONRZTD6W.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-RQV3YVSM.js";
import {
  require_pick
} from "./chunk-INWDSHI3.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-UXMXEJAG.js";
import {
  useEnterprise
} from "./chunk-LJRBJUC3.js";
import {
  Login
} from "./chunk-UONN66QZ.js";
import {
  MemoizedInputRenderer
} from "./chunk-DIL3PSSV.js";
import {
  Form
} from "./chunk-MX5EMUAJ.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-5NGUAYU2.js";
import {
  ConfigurationProvider
} from "./chunk-UREL3Q3U.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-ULYDK7QK.js";
import {
  require_baseRest
} from "./chunk-PSRPIBEF.js";
import {
  HistoryProvider
} from "./chunk-PDUWWKTS.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-BGEAKOZO.js";
import {
  Layouts
} from "./chunk-ZM3IMC7O.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-PURXT6PQ.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-MKHCTGCM.js";
import {
  getByteSize
...
} from "./chunk-U2LSVFXR.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-CSZLSSV6.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-JHXHXBNG.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-ZEZGCTWU.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-AGMNQKER.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-Y2YVCDVS.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-OQ2QOXJO.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-V3XIUP66.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-YSCU6G3U.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-VGEYD72W.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CWIL4UPY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-YHLPL72G.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OH6633CI.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-636OJXLA.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LHI6UCI2.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-LCI4EPDY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-IZ7U4XDT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-EQASQ5JB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-BXFSMQPU.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-7BNNFQIK.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-X2MNFGYL.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-2WMNBJXH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-CPJKFG3W.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-OKI2Y4TM.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-UALY3ELK.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-HLXE5AIU.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-LWMZD5YD.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-6OL3W4PJ.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-NAXZAXGI.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-3A6NVPMW.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-S4HEPWSJ.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-IEPIHRQQ.js");
              return {
...
//# sourceMappingURL=chunk-M5TYDQAN.js.map
