...
import {
  LimitsModal
} from "./chunk-7K5LX54E.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-76QSIOPR.js";
import {
  getStageColorByHex
} from "./chunk-C2IPEJI6.js";
import {
...
} from "./chunk-KYI5KZ6U.js";
import {
  useTypedSelector
} from "./chunk-YHLTOB3J.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-GYXLLRCS.js";
import {
  PERMISSIONS as PERMISSIONS5,
  ReleaseActionMenu,
  ReleaseActionOptions,
  pluginId as pluginId4
} from "./chunk-IFJLVSR4.js";
import {
  index
} from "./chunk-DECTWGZF.js";
import {
  getTimezoneOffset,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-WEZMGZ3E.js";
import {
  useConfig
} from "./chunk-6LPKNYI2.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-Q7VKFRC2.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-KYL6Z4T6.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-V7SN2PQO.js";
import {
  renderAdmin
} from "./chunk-CX74SJ7Q.js";
import {
  useLicenseLimits
} from "./chunk-HVZFOG6L.js";
import {
  Table,
  useTable
} from "./chunk-MSZDVF75.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-FNKJZNPA.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-FQD6NQ3B.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-QTKFHHAP.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-EHOT23KK.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-JH7XACOZ.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-QSJD4HME.js");
    case "./translations/uk.json":
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-MEH533H3.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-6MSV4HQB.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-ZV72XNXY.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-XH4QQQF6.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-YAANRPKG.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-XC7OSH6I.js");
          return {
...
//# sourceMappingURL=chunk-G4IXVHZX.js.map
