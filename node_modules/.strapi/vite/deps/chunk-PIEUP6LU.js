...
import {
  LimitsModal
} from "./chunk-FIZRY72E.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-Z6OTNBIX.js";
import {
  getStageColorByHex
} from "./chunk-M6T5TICF.js";
import {
...
} from "./chunk-PGURYWHK.js";
import {
  useTypedSelector
} from "./chunk-JU5K55YF.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-PSUKQX43.js";
import {
  PERMISSIONS as PERMISSIONS5,
  ReleaseActionMenu,
  ReleaseActionOptions,
  pluginId as pluginId4
} from "./chunk-GS4442RR.js";
import {
  index
} from "./chunk-EQ7JNQ5S.js";
import {
  getTimezoneOffset,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-HBQEPZME.js";
import {
  useConfig
} from "./chunk-VWPDOT2M.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-XGQASAAZ.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-JJJKN6DM.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-5DDP5CQ5.js";
import {
  useIntl
} from "./chunk-LRVODCJD.js";
import {
  renderAdmin
} from "./chunk-YGVTRKQ2.js";
import {
  useLicenseLimits
} from "./chunk-6DZTTCET.js";
import {
  Table,
  useTable
} from "./chunk-ATM64ZJ6.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-NVC2LKY2.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-3DUODN3E.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-KLITXMZQ.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-WUZ2NMIK.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-ZJAT57YW.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-KC7WXTJ2.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-6VA72LWL.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-PTW2WQGD.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-LDMQ7Y4Y.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-OEII5HMO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-TJ4E6VNN.js");
          return {
...
//# sourceMappingURL=chunk-PIEUP6LU.js.map
