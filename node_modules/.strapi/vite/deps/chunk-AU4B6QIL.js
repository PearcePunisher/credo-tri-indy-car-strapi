...
import {
  reducer
} from "./chunk-FG2QANSL.js";
import {
  DEFAULT_BULK_ACTIONS,
  DEFAULT_TABLE_ROW_ACTIONS
} from "./chunk-4PVQ7MV6.js";
import {
  ActionsPanel,
  DEFAULT_ACTIONS,
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-FF3A7PQ6.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register([
      {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-VDOB4J2X.js");
      ...
      },
      {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-VDOB4J2X.js");
...
//# sourceMappingURL=chunk-AU4B6QIL.js.map
