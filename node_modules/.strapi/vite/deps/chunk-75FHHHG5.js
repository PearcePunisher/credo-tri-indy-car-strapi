import {
  ...
  QueryClientProvider,
  img
} from "./chunk-XGAFFV4H.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-CMQ5TXVE.js";
import {
  useNpsSurveySettings
} from "./chunk-E74HLFFS.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-UO5HWOBQ.js";
import {
  UnstableGuidedTourContext
} from "./chunk-NVY3U5JE.js";
import {
  require_pick
} from "./chunk-FFM4DZM4.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-RWMW57S6.js";
import {
  useEnterprise
} from "./chunk-FPZG6URS.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-MW2GEAAJ.js";
import {
  Login
} from "./chunk-7SXGFFDI.js";
import {
  MemoizedInputRenderer
} from "./chunk-BGWRF3GD.js";
import {
  Form
} from "./chunk-X5AHMEEK.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-TQWVKMZZ.js";
import {
  ConfigurationProvider
} from "./chunk-33KTGYUK.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-5GWXYVYR.js";
import {
  require_baseRest
} from "./chunk-7TJDAO42.js";
import {
  HistoryProvider
} from "./chunk-EWPGSFNC.js";
import {
  errorsTrads
...
import {
  TrackingProvider,
  useTracking
} from "./chunk-SOP7DAXI.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-5FJJVU7Y.js";
import {
  getByteSize
...
} from "./chunk-LF33BP4W.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-3NZV5W4K.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-5XKYZVKX.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-X6W6EXXS.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-GFJT5OQ3.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-KO2URU5F.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MLQY7OUV.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-JFYYCPAK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-C7X7A3QI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-3BBDJ2WA.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-5AHO2I7C.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-CTCRUGTX.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-IHYGPROK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-XMYWARYE.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-HGTKQGIB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-TKIDPSPJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-MLA7EXZW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-CGIBVUKF.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-5A3ITBK4.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-I4I6JWJ2.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-VBZQAE6O.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-TMATTE4U.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-GLWQEUUH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-AQDEURKU.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-X3RYSSIY.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-6WPDYMWA.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-CWMMT32G.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-CYSCAO54.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-AHT33AOA.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-3SQR3DP2.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-LZDMHCVB.js");
              return {
...
function __variableDynamicImportRuntime2__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-DB7L45JG.js");
    case "./translations/es.json":
      return import("./es.json-JSZRGZHR.js");
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-QIDICJNV.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-LOMOSON3.js");
...
//# sourceMappingURL=chunk-75FHHHG5.js.map
