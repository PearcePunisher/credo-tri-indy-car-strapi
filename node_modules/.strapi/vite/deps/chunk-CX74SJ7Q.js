...
var ROUTES_CE = [
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-C5SBKPZO.js");
      return {
        Component: ProtectedListPage
      };
    },
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-OHLBVBNH.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-3SHEMYBA.js");
...
//# sourceMappingURL=chunk-CX74SJ7Q.js.map
