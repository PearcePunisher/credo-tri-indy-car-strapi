...
import {
  Filters
} from "./chunk-O2S2H3OG.js";
import {
  Pagination
} from "./chunk-LT6WNP7O.js";
import {
  Table
...
import {
  SearchInput
} from "./chunk-6E4MLB3W.js";
import {
  ConfirmDialog
} from "./chunk-X544JNLD.js";
import {
  useRBAC
...
var ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(MagicLinkCE, async () => (await import("./MagicLinkEE-3Q3ELIDA.js")).MagicLinkEE);
...
var ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(CreateActionCE, async () => (await import("./CreateActionEE-ECMGTME2.js")).CreateActionEE);
...
var ListPage = () => {
  const UsersListPage = useEnterprise(ListPageCE, async () => (
    ...
    (await import("./ListPage-VUQKHUKY.js")).UserListPageEE
  ));
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=chunk-TTDYK7WS.js.map
